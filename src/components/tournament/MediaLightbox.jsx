    ...
    <Modal isOpen={isOpen} onClose={onClose} title={item.title} maxWidth="max-w-4xl">
      <div className="space-y-4">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 p-4 bg-bgmi-dark/70 dark:bg-bgmi-dark/70 light:bg-slate-100 rounded-xl border border-bgmi-border/40 dark:border-bgmi-border/40 light:border-slate-200 text-xs">
          <div>
            <p className="text-slate-400 dark:text-slate-400 light:text-slate-600">Team: <span className="text-white dark:text-white light:text-slate-900 font-bold">{item.team}</span></p>
          ...
          <div>
            <p className="text-slate-400 dark:text-slate-400 light:text-slate-600">Match: <span className="text-bgmi-cyan dark:text-bgmi-cyan light:text-sky-600 font-bold">{item.match}</span></p>
