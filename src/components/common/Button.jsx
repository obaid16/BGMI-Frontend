...
export default function Button({
  ...
  const variantStyles = {
    ...
    cyan: 'bg-bgmi-red hover:bg-bgmi-red-hover text-white font-black border border-red-500/50 shadow-md shadow-red-glow/30',
    danger: 'bg-bgmi-red hover:bg-bgmi-red-hover text-white border border-red-500',
    outline: 'bg-transparent text-slate-800 dark:text-slate-200 border border-slate-300 dark:border-slate-700 hover:border-bgmi-red hover:text-bgmi-red dark:hover:text-white hover:bg-bgmi-red/10',
