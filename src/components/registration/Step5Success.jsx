...
export default function Step5Success({ registrationId, onReset }) {
  return (
    <div className="text-center py-8 space-y-6 max-w-2xl mx-auto animate-in zoom-in-95 duration-300">
      <div className="w-20 h-20 bg-emerald-500/20 border border-emerald-500 text-emerald-600 dark:text-emerald-400 rounded-full flex items-center justify-center mx-auto shadow-lg">
      ...
      <div className="space-y-3">
        ...
        <div className="p-4 bg-slate-100 dark:bg-bgmi-dark/90 border border-slate-200 dark:border-bgmi-border rounded-xl max-w-lg mx-auto space-y-2 text-left shadow-sm">
      ...
      <div className="p-6 bg-white dark:bg-bgmi-surface/90 border border-bgmi-red/60 rounded-2xl clip-tactical shadow-md dark:shadow-red-glow space-y-2 max-w-md mx-auto">
        <p className="text-[10px] uppercase font-black text-slate-600 dark:text-slate-400 tracking-widest">Official Registration Pass ID</p>
      ...
      <div className="p-5 bg-emerald-500/10 border border-emerald-500/30 rounded-2xl space-y-3 max-w-md mx-auto text-center clip-tactical">
        <h4 className="font-display font-bold text-sm text-emerald-700 dark:text-emerald-400 uppercase tracking-wide flex items-center justify-center gap-2">
          <MessageCircle className="w-4 h-4 text-emerald-700 dark:text-emerald-400" /> Join Captains' WhatsApp Group
        </h4>
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="inline-flex items-center justify-center gap-2 w-full px-4 py-2.5 bg-emerald-600 hover:bg-emerald-500 text-white font-black rounded-lg text-xs uppercase tracking-wider transition-all shadow-md active:scale-95"
        >
