...
export const CANONICAL_TEAMS = [
  ...
  },
  {
    ...
    teamName: 'Axions',
    shortName: 'AXN',
    collegeName: 'NIT Electronics Engineering',
    captainName: 'Kratos',
    captainIgn: 'AXN-Kratos',
    captainRole: 'IGL',
    contactNumber: '+91 98765 43211',
    email: 'kratos@nitesports.edu',
  ...
  },
  {
    ...
    shortName: 'ELT',
    collegeName: 'NIT Mechanical Dept',
    captainName: 'Naman Mathur',
    captainIgn: 'ELT-Mortal',
    captainRole: 'IGL / Support',
    contactNumber: '+91 98765 43212',
    email: 'mortal@nitesports.edu',
    logoUrl: 'https://images.unsplash.com/photo-1538481199705-c710c4e965fc?w=800&auto=format&fit=crop&q=80',
    status: 'Approved',
    verified: true,
    rank: 3,
    points: 25,
