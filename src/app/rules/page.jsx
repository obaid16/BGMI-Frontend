...
export default function RulesPage() {
  ...
  if (rules.length === 0) {
    return (
      <div className="max-w-[1200px] mx-auto px-6 lg:px-8 py-16 text-center">
  ...
  return (
    <div className="max-w-[1400px] mx-auto px-6 lg:px-8 py-16">
      ...
      {/* HEADER */}
      <div className="border-b border-premium-border pb-8 mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div className="space-y-4">
          ...
          <p className="text-base text-premium-text-secondary font-medium max-w-2xl">
